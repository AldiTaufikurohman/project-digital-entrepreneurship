...
<head>
    ...
    <title>Masuk & Daftar — Belajaryuk</title>
    ...
    <style>
        * {
        ...
        /* HALAMAN KANAN STABIL (BASE FORM DAFTAR) */
        .page-right {
            width: 50%;
            height: 100%;
            padding: 40px;
        ...
        /* MUKA DEPAN (FORM MASUK) & BELAKANG (COVER BUKU BELAKANG) */
...
<body>
    ...
    <div class="book-wrapper">
        <div class="real-book" id="myBook">
            ...
            <!-- 1. HALAMAN KIRI STABIL (INFO) -->
            <div class="page-left">
                <a href="../pages/index.html" class="brand"><span>BELAJAR</span>YUK</a>
                <div class="banner-text">
                    <h2>Selamat Datang!</h2>
                    <p>Buka lembaran barumu hari ini. Akses materi eksklusif dan kembangkan keahlian digitalmu bersama kami.</p>
                </div>
            ...
            <div class="flipper-page">
                ...
                <!-- SISI DEPAN LEMBARAN: FORM MASUK -->
                ...
                <!-- SISI BELAKANG LEMBARAN: COVER DAFTAR -->
                <div class="flipper-back">
                    <a href="../pages/index.html" class="brand"><span>BELAJAR</span>YUK</a>
                    <div class="banner-text">
                        <h2>Bergabung Gratis!</h2>
                        <p>Dapatkan pengalaman belajar interaktif, sertifikat, dan jaringan dengan talenta digital lainnya.</p>
                    </div>
            ...
            <!-- 3. HALAMAN KANAN STABIL (FORM DAFTAR) -->
            <div class="page-right">
                ...
                <div class="switch-prompt">
                    Sudah punya akun?
                    <button type="button" class="btn-flip" onclick="openLoginPage()">Kembali ke Masuk</button>
                </div>
